		...
		<tr className="bg-white border-b hover:bg-gray-50">
			...
			{isStakingModalOpen && (
				<div ref={stakeTokenModalWrapper}>
					<StakeTokenModal tokenId={id} userTokenBalance={1} setIsStakingModalOpen={setIsStakingModalOpen} endTime={Date.now() / 1000} projectName={projectName} tokenPrice={sales} tokenTicker={projectName} />
				</div>
			)}
		</tr>
	);
