...
function About() {
	return (
		<main className="w-full flex flex-col items-center bg-gray-100">
			<div className="flex flex-col w-full py-8 md:py-16 bg-auto text-white bg-[url('/about_hero.png')] justify-center mb-12">
			...
			<div className="w-3/4 space-y-32 self-center mb-20">
